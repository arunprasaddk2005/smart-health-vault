        ...
        try {
            ...
            if (response.data.profile) {
                setFormData({
                    ...
                    chronicConditions: response.data.profile.chronicConditions.length > 0
                        ? response.data.profile.chronicConditions
                        : [{ name: '', diagnosedDate: '', currentStatus: '' }],
                    currentMedications: response.data.profile.currentMedications.length > 0
                        ? response.data.profile.currentMedications
                        : [{ name: '', dosage: '', frequency: '', purpose: '' }],
                    emergencyContacts: response.data.profile.emergencyContacts.length > 0
                        ? response.data.profile.emergencyContacts
                        ...
                        <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="bg-white rounded-lg shadow p-6">
                                ...
                                {formData.emergencyContacts.map((contact, index) => (
                                    <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4 p-4 border border-gray-200 rounded-lg items-end">
                                        <div>
